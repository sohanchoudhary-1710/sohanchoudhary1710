                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">User Management with minimal features & hover style</h3>
                                </div>
                                                    ...
                                                    <td>
                                                        <a href="#editEmployeeModal" class="edit" data-toggle="modal">
                                                            <i class="material-icons update" data-toggle="tooltip"
                                                                ...
                                                                title="Edit"><button class="btn btn-info">EDIT</button></i>
                                                        </a>
                                                        <a href="#deleteEmployeeModal" class="delete"
                                                            data-id="<?php echo $row["id"]; ?>" data-toggle="modal"><i
                                                                class="material-icons" data-toggle="tooltip"
                                                                title="Delete">
                                                                <buttton class="btn btn-danger">DELETE</button>
                                                            </i></a>
                                                    </td>
                                                </tr>
                                                <?php
